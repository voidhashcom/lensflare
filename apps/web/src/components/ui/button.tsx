  ...
  "[&_svg]:-mx-0.5 relative inline-flex shrink-0  items-center justify-center gap-2 whitespace-nowrap rounded-lg border font-medium text-base outline-none before:pointer-events-none before:absolute before:inset-0 before:rounded-[calc(var(--radius-lg)-1px)] pointer-coarse:after:absolute pointer-coarse:after:size-full pointer-coarse:after:min-h-11 pointer-coarse:after:min-w-11 focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-1 focus-visible:ring-offset-background disabled:pointer-events-none disabled:opacity-64 sm:text-sm [&_svg:not([class*='opacity-'])]:opacity-80 [&_svg:not([class*='size-'])]:size-4.5 sm:[&_svg:not([class*='size-'])]:size-4 [&_svg]:pointer-events-none [&_svg]:shrink-0",
  {
    ...
    variants: {
      size: {
        ...
        icon: "size-8 rounded-md text-muted-foreground/70 before:rounded-[calc(var(--radius-md)-1px)] hover:text-foreground data-pressed:text-foreground hover:[&_svg:not([class*='opacity-'])]:opacity-100 data-pressed:[&_svg:not([class*='opacity-'])]:opacity-100 sm:size-8 [&_svg:not([class*='opacity-'])]:opacity-65",
        "icon-lg":
      ...
      variant: {
        ...
        ghost: "border-transparent data-pressed:bg-accent [:hover,[data-pressed]]:bg-accent/60",
