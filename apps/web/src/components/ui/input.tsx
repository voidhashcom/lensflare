...
function Input({
  ...
  // Base UI's `style` prop accepts either `CSSProperties` or a function of the
  // component state. A native `<input>` only accepts the plain object form, so
  // drop function styles when rendering the native fallback.
