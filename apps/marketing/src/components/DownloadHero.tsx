...
import { GITHUB_RELEASES_URL, LATEST_VERSION } from "../lib/links";
 ...
 * the way down.
 */
export function DownloadHero(): ReactNode {
  return (
      ...
      <div className="mx-auto flex max-w-[1152px] flex-col items-start gap-8 border-x border-border px-8 pt-24 pb-20">
        <div className="flex flex-col items-start gap-4">
          ...
          <p className="max-w-[520px] text-[14px] leading-[150%] text-[#6B6B6B]">
            A development observability stack for humans and agents. Free, open
            source, and built for macOS, Windows, and Linux.
          </p>
        </div>
        ...
        <div className="flex items-center gap-3 rounded-full border border-border bg-[#FAFAFA] py-1.5 pr-1.5 pl-3.5">
          <span
            aria-hidden="true"
            className="h-1.5 w-1.5 shrink-0 rounded-full bg-[#2DB47A]"
          />
